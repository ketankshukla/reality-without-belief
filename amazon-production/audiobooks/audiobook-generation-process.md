# Audiobook Generation Process

Drop this file into a new project's `audiobooks` folder and ask Cascade to read it and execute.
...
Files are numbered sequentially (01, 02, 03...) for playlist compatibility:
- Front matter: 01-06
- Chapters: 07-XX (depends on number of chapters)
- Back matter: XX-YY (continues from chapters)

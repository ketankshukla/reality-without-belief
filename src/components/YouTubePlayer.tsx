...
export default function YouTubePlayer({
  ...
  return (
    <div className="relative h-full w-full overflow-hidden rounded-2xl border border-turquoise/20">
      ...
      >
        <div className="h-16 w-16 rounded-full border-2 border-turquoise/60 bg-black/60 backdrop-blur-sm flex items-center justify-center">
          {isPlaying ? (
            <Pause className="h-7 w-7 text-turquoise" />
          ) : (
            <Play className="h-7 w-7 text-turquoise ml-0.5" />
          )}
        </div>
      </div>
    </div>

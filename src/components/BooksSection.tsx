      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-5 mb-12">
          {books.map((book, index) => (
            <div
              key={book.id}
              className="flex flex-col overflow-hidden rounded-xl border border-turquoise/20 bg-navy-light/40"
            >
              ...
              <div className="flex flex-col flex-1 p-3 sm:p-4">
                <p className="font-serif text-xs tracking-[0.25em] uppercase text-turquoise/60 mb-1">
                  Book {book.roman}
                </p>

# make_book_docx.ps1
# Usage: .\make_book_docx.ps1 -BookFolder "Reality Without Belief Book 1 - Why We Believe, Why It Fails, and What It Costs Us"
...
$bookPath = Join-Path "E:\reality-without-belief\book-series" $BookFolder
...
# --- Output paths ---
$outDir = "E:\reality-without-belief\book-series\word-docs"

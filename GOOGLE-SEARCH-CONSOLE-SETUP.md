# Google Search Console Setup — reality.ketanshukla.com
...
1. Choose **"URL prefix"**
2. Enter: `https://reality.ketanshukla.com`
3. Click **"Continue"**
...
2. Place it in `E:\reality-without-belief\public\`
3. It will be accessible at `https://reality.ketanshukla.com/googleXXXXXXXXXXXXXXXX.html`
...
2. Enter: `sitemap.xml`
3. Click **"Submit"**
4. Full URL: `https://reality.ketanshukla.com/sitemap.xml`

### Step 5: Request Indexing

1. In the left sidebar, click **"URL Inspection"**
2. Paste: `https://reality.ketanshukla.com/`
...
|-----|----------|-----------------|
| `https://reality.ketanshukla.com` | 1.0 | monthly |
...
Sitemap: https://reality.ketanshukla.com/sitemap.xml
```
